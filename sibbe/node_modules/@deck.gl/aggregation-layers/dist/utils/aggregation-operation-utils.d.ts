...
export declare function getValueFunc(aggregation: any, accessor: any, context: any): ((pts: any) => any) | null;
type AccessorContext = {
    data?: any;
    index?: number;
    indices?: number[];
};
export declare function wrapGetValueFunc(getValue: any, context?: AccessorContext): (pts: any) => any;
export {};
