...
import type LayerExtension from "../lib/layer-extension.js";
import type { BinaryAttribute } from "../lib/attribute/attribute.js";
import type { ConstructorOf, NumericArray, TypedArray } from "./types.js";
import type { PickingInfo } from "../lib/picking/pick-info.js";
import type { MjolnirEvent } from 'mjolnir.js';
import type { Texture, TextureProps } from '@luma.gl/core';
import type { Buffer, Parameters } from '@luma.gl/core';
import type { Loader } from '@loaders.gl/loader-utils';
import type { LightingModuleSettings } from "../shaderlib/index.js";
export type LayerData<T> = Iterable<T> | {
    length: number;
...
export type Color = [number, number, number] | [number, number, number, number] | Uint8Array | Uint8ClampedArray;
...
export type TextureSource = Texture | TextureProps | HTMLImageElement | ImageData | HTMLCanvasElement | HTMLVideoElement | ImageBitmap;
/**
 ...
 * * `null` - empty data
 */
export type LayerDataSource<DataType> = LayerData<DataType> | string | AsyncIterable<DataType[]> | Promise<LayerData<DataType>> | null;
/**
...
export type LayerProps = {
     ...
     */
    dataTransform?: (<LayerDataT = LayerData<unknown>>(data: unknown, previousData?: LayerDataT) => LayerDataT) | null;
    /**
