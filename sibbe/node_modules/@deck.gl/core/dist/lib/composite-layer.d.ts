import Layer, { UpdateParameters } from "./layer.js";
...
import type { LayersList, LayerContext } from "./layer-manager.js";
import type { CompositeLayerProps, Accessor } from "../types/layer-props.js";
import { ConstructorOf } from "../types/types.js";
export default abstract class CompositeLayer<PropsT extends {} = {}> extends Layer<PropsT & Required<CompositeLayerProps>> {
