import { Accessor, AccessorFunction, Color, CompositeLayer, CompositeLayerProps, Layer, LayerDataSource, LayersList, Unit, Material, UpdateParameters, DefaultProps } from '@deck.gl/core';
/**
...
export default class PolygonLayer<DataT = any, ExtraProps extends {} = {}> extends CompositeLayer<Required<_PolygonLayerProps<DataT>> & ExtraProps> {
    static layerName: string;
    static defaultProps: DefaultProps<PolygonLayerProps<unknown>>;
    state: {
        paths: number[][];
        pathsDiff: {
            startRow: number;
