...
`;
  ...
  var ArcLayer = class extends import_core2.Layer {
    ...
    getShaders() {
      return super.getShaders({ vs: arc_layer_vertex_glsl_default, fs: arc_layer_fragment_glsl_default, modules: [import_core2.project32, import_core2.picking] });
    }
    get wrapLongitude() {
      return false;
    }
...
`;
  ...
  var BitmapLayer = class extends import_core4.Layer {
    getShaders() {
      return super.getShaders({ vs: bitmap_layer_vertex_default, fs: bitmap_layer_fragment_default, modules: [import_core4.project32, import_core4.picking] });
    }
    initializeState() {
      const attributeManager = this.getAttributeManager();
...
`;
  ...
  var IconLayer = class extends import_core7.Layer {
    getShaders() {
      return super.getShaders({ vs: icon_layer_vertex_glsl_default, fs: icon_layer_fragment_glsl_default, modules: [import_core7.project32, import_core7.picking] });
    }
    initializeState() {
      this.state = {
...
`;
  ...
  var LineLayer = class extends import_core8.Layer {
    ...
    getShaders() {
      return super.getShaders({ vs: line_layer_vertex_glsl_default, fs: line_layer_fragment_glsl_default, modules: [import_core8.project32, import_core8.picking] });
    }
    get wrapLongitude() {
      return false;
    }
...
`;
  ...
  var PointCloudLayer = class extends import_core9.Layer {
    getShaders() {
      return super.getShaders({ vs: point_cloud_layer_vertex_glsl_default, fs: point_cloud_layer_fragment_glsl_default, modules: [import_core9.project32, import_core9.gouraudLighting, import_core9.picking] });
    }
    initializeState() {
...
`;
  ...
  var ScatterplotLayer = class extends import_core10.Layer {
    getShaders() {
      return super.getShaders({ vs: scatterplot_layer_vertex_glsl_default, fs: scatterplot_layer_fragment_glsl_default, modules: [import_core10.project32, import_core10.picking] });
    }
    initializeState() {
      this.getAttributeManager().addInstanced({
        instancePositions: {
  ...
  var ColumnLayer = class extends import_core12.Layer {
    getShaders() {
      ...
      return super.getShaders({
        ...
        defines,
        modules: [import_core12.project32, flatShading ? import_core12.phongLighting : import_core12.gouraudLighting, import_core12.picking]
      });
    }
    initializeState() {
      const attributeManager = this.getAttributeManager();
...
`;
  ...
  var PathLayer = class extends import_core15.Layer {
    getShaders() {
      return super.getShaders({ vs: path_layer_vertex_glsl_default, fs: path_layer_fragment_glsl_default, modules: [import_core15.project32, import_core15.picking] });
    }
    get wrapLongitude() {
      return false;
    }
  ...
  var SolidPolygonLayer = class extends import_core17.Layer {
    getShaders(type) {
      return super.getShaders({
        ...
        modules: [import_core17.project32, import_core17.gouraudLighting, import_core17.picking]
      });
    }
    get wrapLongitude() {
      return false;
    ...
    initializeState() {
      ...
      if (viewport.isGeospatial && coordinateSystem === import_core17.COORDINATE_SYSTEM.DEFAULT) {
        coordinateSystem = import_core17.COORDINATE_SYSTEM.LNGLAT;
      }
      let preproject;
      if (coordinateSystem === import_core17.COORDINATE_SYSTEM.LNGLAT) {
        if (_full3d) {
...
`;
  ...
  var import_engine17 = __toESM(require_engine(), 1);
...
`;
  ...
  var TextBackgroundLayer = class extends import_core22.Layer {
    getShaders() {
      return super.getShaders({ vs: text_background_layer_vertex_glsl_default, fs: text_background_layer_fragment_glsl_default, modules: [import_core22.project32, import_core22.picking] });
    }
    initializeState() {
      this.getAttributeManager().addInstanced({
        instancePositions: {
  ...
  var TextLayer = class extends import_core23.CompositeLayer {
    ...
    initializeState() {
      ...
      if (this.props.maxWidth > 0) {
        import_core23.log.warn("v8.9 breaking change: TextLayer maxWidth is now relative to text size")();
      }
    }
    updateState(params) {
      const { props, oldProps, changeFlags } = params;
