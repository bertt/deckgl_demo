...
const MAPBOX_TOKEN  = `pk.eyJ1IjoiYmVydHRlbW1lIiwiYSI6ImNtMjA3M21zZjBjbWUya3IyZmYzeXhwbmQifQ.YmxccPvO-kGKmB7zX6LMvg`;
...
const SURFACE_IMAGE = `https://api.mapbox.com/v4/mapbox.satellite/{z}/{x}/{y}@2x.jpg90?access_token=${MAPBOX_TOKEN}`;
